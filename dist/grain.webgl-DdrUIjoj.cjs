...
`,y=24e5,W=7;function O(t){const n=/^#([0-9a-f]{6})$/i.exec(t.trim());if(!n)throw new Error(`Background colours must be #rrggbb, got "${t}".`);return[0,2,4].map(e=>parseInt(n[1].slice(e,e+2),16)/255)}function G(t,n,e,g,i=1/0){var M,w;const v=t.autoplay!==!1,S=window.matchMedia("(prefers-reduced-motion: reduce)");let m=window.matchMedia(`(resolution: ${window.devicePixelRatio||1}dppx)`),_=window.devicePixelRatio||1,c=e.clientWidth,a=e.clientHeight,L=!0,l=!1,s=t.theme==="light"?1:0,u=s,E=0,f=0,d=0,T=null;function h(){return!l&&!document.hidden&&L&&c>0&&a>0}function x(){const o=Math.min(_,2,Math.sqrt(y/(c*a)),i/c,i/a),r=Math.max(1,Math.floor(c*o)),P=Math.max(1,Math.floor(a*o));return(e.width!==r||e.height!==P)&&(e.width=r,e.height=P),r/c}function A(o){if(!l&&(d=o,!!h()))try{n(o,u,x())}catch(r){k();const P=r instanceof Error?r:new Error(String(r));t.onError?t.onError(P):console.error(P)}}function F(){!E&&h()&&(E=requestAnimationFrame(N))}function R(){h()?F():(cancelAnimationFrame(E),E=0,T=null)}function N(o){if(E=0,!h()){T=null;return}const r=T===null?0:Math.min((o-T)/1e3,.1);T=o,v&&(S.matches||(f+=r),u+=(s-u)*(1-Math.exp(-r*W)),Math.abs(s-u)<.002&&(u=s)),A(v?f:d),v&&(!S.matches||u!==s)?F():T=null}function b(){if(l)return;const o=window.devicePixelRatio||1;_!==o&&(_=o,m.removeEventListener("change",b),m=window.matchMedia(`(resolution: ${o}dppx)`),m.addEventListener("change",b),R())}const I=new ResizeObserver(([o])=>{if(l||!o)return;const r=o.contentRect;c===r.width&&a===r.height||(c=r.width,a=r.height,R())}),p=new IntersectionObserver(([o])=>{l||!o||L===o.isIntersecting||(L=o.isIntersecting,R())});function k(){var o;l||(l=!0,cancelAnimationFrame(E),E=0,I.disconnect(),p.disconnect(),m.removeEventListener("change",b),S.removeEventListener("change",R),document.removeEventListener("visibilitychange",R),window.removeEventListener("resize",b),(o=t.signal)==null||o.removeEventListener("abort",k),g())}return I.observe(e),p.observe(e),m.addEventListener("change",b),S.addEventListener("change",R),document.addEventListener("visibilitychange",R),window.addEventListener("resize",b),(M=t.signal)==null||M.addEventListener("abort",k,{once:!0}),(w=t.signal)!=null&&w.aborted?k():F(),{setTheme(o){l||(s=o==="light"?1:0,v?R():(u=s,A(d)))},render:A,destroy:k}}function H(t,n,e,g){const i=t.createShader(e);if(!i)throw new Error("WebGL could not create a shader object.");if(t.shaderSource(i,g),t.compileShader(i),!t.getShaderParameter(i,t.COMPILE_STATUS))throw new Error(`Shader failed to compile: ${t.getShaderInfoLog(i)}`);t.attachShader(n,i),t.deleteShader(i)}function C(t,n){const e=t.createProgram();if(H(t,e,t.VERTEX_SHADER,D),H(t,e,t.FRAGMENT_SHADER,n),t.linkProgram(e),!t.getProgramParameter(e,t.LINK_STATUS))throw new Error(`Shader failed to link: ${t.getProgramInfoLog(e)}`);return e}function U(t,n,e){return Object.fromEntries(e.map(g=>[g,t.getUniformLocation(n,g)]))}function Y(t,n={}){var u,E;const e=t.getContext("webgl2",{alpha:!1,antialias:!1,depth:!1,stencil:!1});if(!e)throw new Error("WebGL2 is not available in this browser.");const g=O(((u=n.background)==null?void 0:u.dark)??"#090909"),i=O(((E=n.background)==null?void 0:E.light)??"#ffffff"),v=C(e,B),S=U(e,v,["iResolution","iTime","uLightMode","uDarkBackground","uLightBackground"]),m=C(e,X),_=U(e,m,["tScene","iResolution","iTime","uLightMode","uDarkBackground","uLightBackground","uPixelRatio"]),c=e.createFramebuffer(),a=e.createTexture();e.bindTexture(e.TEXTURE_2D,a),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);let L=0,l=0;const s=(f,d,T)=>{e.uniform2f(f.iResolution,t.width,t.height),e.uniform1f(f.iTime,d),e.uniform1f(f.uLightMode,T),e.uniform3fv(f.uDarkBackground,g),e.uniform3fv(f.uLightBackground,i)};return G(n,(f,d,T)=>{const{width:h,height:x}=t;e.viewport(0,0,h,x),(L!==h||l!==x)&&(L=h,l=x,e.bindTexture(e.TEXTURE_2D,a),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,h,x,0,e.RGBA,e.UNSIGNED_BYTE,null),e.bindFramebuffer(e.FRAMEBUFFER,c),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,a,0),e.bindFramebuffer(e.FRAMEBUFFER,null));const A=F=>{e.bindFramebuffer(e.FRAMEBUFFER,c),e.useProgram(v),s(S,f,F),e.drawArrays(e.TRIANGLES,0,3),e.bindFramebuffer(e.FRAMEBUFFER,null),e.useProgram(m),s(_,f,F),e.uniform1f(_.uPixelRatio,T),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,a),e.uniform1i(_.tScene,0),e.drawArrays(e.TRIANGLES,0,3)};if(d<=0||d>=1){A(d);return}A(0),e.enable(e.BLEND),e.blendColor(0,0,0,d),e.blendFunc(e.CONSTANT_ALPHA,e.ONE_MINUS_CONSTANT_ALPHA),A(1),e.disable(e.BLEND)},t,()=>{e.deleteProgram(v),e.deleteProgram(m),e.deleteFramebuffer(c),e.deleteTexture(a)},Math.min(e.getParameter(e.MAX_TEXTURE_SIZE),e.getParameter(e.MAX_RENDERBUFFER_SIZE)))}exports.createShader=Y;
